...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Da3hevYg.js");
...
const manifest = {
  "a87d015ab2eacb8af743f08c75ab982e33d2be295a710d9d1ab77a9080bce269": {
    functionName: "analyzeBusiness_createServerFn_handler",
    importer: () => import("./analyze.functions-HIOuHUwr.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-a-ZVz9j9.js"),
    import("./start-DmExD9Ns.js"),
